...
def read_item(id,root_path = '/dataset/50_point_inpainting'):
    ...
    pe_croppe_bin_path = os.path.join(root_path,'orignial_2_croppe_bin')
    ...
    for index in range(orignial_annotations['name'].size):
        if orignial_annotations['name'][index] == 'Pedestrian':
            pe_bboxs.append(orignial_annotations['bbox'][index])
